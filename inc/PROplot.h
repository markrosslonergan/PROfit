...
namespace PROfit{
    ...
    int plotPriorFractionalSystematicBreakdown(const PROconfig &config, const PROspec &spec, const PROsyst &allsplinesyst, std::string filename, int var_index = 0, std::vector<double> alphas = {});
