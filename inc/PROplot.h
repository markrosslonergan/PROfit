...
namespace PROfit{
    ...
    int plotFractionalSystematicBreakdown(const PROconfig &config, const PROspec &spec, const PROsyst &allsplinesyst, std::string filename, int var_index = 0, std::map<std::string, double> alphas = {});
